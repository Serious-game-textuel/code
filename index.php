...
$event = \mod_serioustextualgame\event\course_module_instance_list_viewed::create(array(
    'context' => $modulecontext,
));
$event->add_record_snapshot('course', $course);
$event->trigger();

$PAGE->set_url('/mod/serioustextualgame/index.php', array('id' => $id));
...
if (empty($serioustextualgames)) {
    notice(get_string('no$serioustextualgameinstances', 'mod_serioustextualgame'), new moodle_url('/course/view.php', array('id' => $course->id)));
}
...
foreach ($serioustextualgames as $serioustextualgame) {
    if (!$serioustextualgame->visible) {
        $link = html_writer::link(
            new moodle_url('/mod/serioustextualgame/view.php', array('id' => $serioustextualgame->coursemodule)),
    ...
    if ($course->format == 'weeks' || $course->format == 'topics') {
        $table->data[] = array($serioustextualgame->section, $link);
    } else {
